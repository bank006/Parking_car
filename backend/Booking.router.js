...
router.post('/postbooking' , (req , res ,next)=>{
    const {IDproductregis , IDuser , storeregis ,startbookingregis, timeregis} = req.body ; 
    BookingSchema.create({IDproductregis , IDuser , storeregis ,startbookingregis, timeregis} , (err , resbooking)=>{
        if(!err ){
